...
$string['notifyemail'] = 'Send notify to these emails';
$string['notifyemail_help'] = 'Enter here a list of email addresses that should be notified when a new badge is issued.';
$string['notifyemail_err'] = 'Invalid email addresses in notification list.';
