...
Feature: Navigate to different contexts in the content bank
  ...
  Scenario: Admins can view and navigate to all the contexts in the content bank
    ...
    And I click on "Choose course or category..." "combobox"
    And I click on ".comboboxsearch .btn-clear" "css_element"
    And I set the field "Choose course or category..." to "c"
    And I wait until "Category" "option_role" exists
    And I should see "Cat 1" in the ".contentbank-context-search .searchresultitemscontainer" "css_element"
    And I should see "Cat 2" in the ".contentbank-context-search .searchresultitemscontainer" "css_element"
    And I should see "Course 0" in the ".contentbank-context-search .searchresultitemscontainer" "css_element"
    And I should see "Course 1" in the ".contentbank-context-search .searchresultitemscontainer" "css_element"
    And I should see "Course 2" in the ".contentbank-context-search .searchresultitemscontainer" "css_element"
    And I should see "santjordi.h5p"
    And I should not see "santjordi_rose.h5p"
    And I should not see "Dragon.h5p"
    And I click on "Cat 1" "list_item" in the ".contentbank-context-search .searchresultitemscontainer" "css_element"
    ...
    And I click on ".comboboxsearch .btn-clear" "css_element"
    And I set the field "Choose course or category..." to "c"
    And I click on "Course 0" "list_item" in the ".contentbank-context-search .searchresultitemscontainer" "css_element"
    Then I wait to be redirected
    And I should not see "santjordi.h5p"
    And I should not see "santjordi_rose.h5p"
