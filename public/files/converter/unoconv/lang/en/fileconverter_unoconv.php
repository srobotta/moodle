...
$string['err_emptyoutputfile'] = 'The output file generated by unoconv was empty.';
$string['err_generic'] = 'An error occurred while executing unoconv to convert the document.';
$string['err_nooutputfile'] = 'No output file was generated by unoconv.';
$string['err_unoconvrequirements'] = 'Missing requirements for unoconv.';
$string['err_unsupportedinformat'] = 'Unsupported input format.';
$string['err_unsupportedoutformat'] = 'Unsupported output format.';
