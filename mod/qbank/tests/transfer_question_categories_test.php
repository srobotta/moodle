...
final class transfer_question_categories_test extends \advanced_testcase {
    ...
    public function test_fix_wrong_parents(): void {
        ...
        $wronggrandchild = $this->create_question_category(
            'Grand child of course 2 parent', $course2context->id + 1000, $secondwrongchild->id);
        ...
        $this->assert_category_is_in_context_with_parent($course2context, $secondwrongchild, $wronggrandchild->id);
    }
